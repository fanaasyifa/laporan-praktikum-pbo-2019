...
public class FormKategori1841720155Fana extends javax.swing.JFrame {

    /**
     * Creates new form FormKategori1841720155Fana
     */
    public FormKategori1841720155Fana() {
        initComponents();
        tampilkanDataFana();
        kosongkanFormFana();
    }
    ...
    public void tampilkanDataFana(){
        ...
        ArrayList<Kategori1841720155Fana> list = new Kategori1841720155Fana().getAllFana();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (Kategori1841720155Fana kat : list) {
            rowData[0] = kat.getIdKategoriFana();
            rowData[1] = kat.getNamaFana();
            rowData[2] = kat.getKeteranganFana();
    ...
    public void cariFana (String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720155Fana> list = new Kategori1841720155Fana().searchFana(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        kat.setIdKategoriFana(Integer.parseInt(txtIdKategori.getText()));
        kat.setNamaFana(txtNama.getText());
        kat.setKeteranganFana(txtKeterangan.getText());
        kat.saveFana();
        txtIdKategori.setText(Integer.toString(kat.getIdKategoriFana()));
        tampilkanDataFana();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720155Fana kat = new Kategori1841720155Fana().getByIdFana(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.deleteFana();
        kosongkanFormFana();
        tampilkanDataFana();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKategori1841720155Fana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKategori1841720155Fana().setVisible(true);
            }
        });
    }
