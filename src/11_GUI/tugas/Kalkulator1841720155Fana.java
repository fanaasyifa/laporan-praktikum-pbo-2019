 ...
 * @author ASUS
 */
public class Kalkulator1841720155Fana extends javax.swing.JFrame{
    
   private double total1 = 0.0;
    private double total2 = 0.0;
    private char math_operator;
    
    public Kalkulator1841720155Fana() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator1841720155Fana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator1841720155Fana().setVisible(true);
            }
        });
    }
