 ...
 * @author ASUS
 */
public class Swing21841720155Fana extends javax.swing.JFrame {
   /**
     * Creates new form Swing2
     */
    public Swing21841720155Fana() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Swing21841720155Fana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Swing21841720155Fana().setVisible(true);
            }
        });
    }
