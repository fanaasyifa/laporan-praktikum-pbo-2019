 ...
 * @author Unero
 */
public class FormBuku1841720155Fana extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuku
     */
    public FormBuku1841720155Fana() {
        initComponents();
        kosongkanForm();
        tampilkanData();
    ...
    public void tampilkanData(){
        ...
        ArrayList<Buku1841720155Fana> list = new Buku1841720155Fana().getAll();
        ...
        for(int i = 0; i < list.size(); i++){
            ...
            rowData[1] = list.get(i).getKategori().getNamaFana();
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Buku1841720155Fana> list = new Buku1841720155Fana().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {},kolom));
        
        for(Buku1841720155Fana buku : list){
            rowData[0] = buku.getIdbuku();
            rowData[1] = buku.getKategori().getNamaFana();
    ...
    public void tampilkanCmbKategori(){
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1841720155Fana().getAllFana().toArray()));
    }
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtPenulis, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                        ...
                        .addComponent(txtIdBuku, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        buku.setKategori((Kategori1841720155Fana)cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1841720155Fana buku = new Buku1841720155Fana().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormBuku1841720155Fana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormBuku1841720155Fana().setVisible(true);
            }
        });
    }
