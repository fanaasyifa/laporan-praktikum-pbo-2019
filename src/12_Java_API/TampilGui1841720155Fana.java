 ...
 * @author MSI GAMING
 */
public class TampilGui1841720155Fana extends javax.swing.JFrame {
    DefaultTableModel TabMahasiswa;
    InputData1841720155Fana DataMahasiswa;

    /**
     * Creates new form TampilGui
     */
    public TampilGui1841720155Fana() {
        DataMahasiswa = new InputData1841720155Fana();
        initComponents();
        LihatDataMahasiswa();
    }
    ...
    public final void LihatDataMahasiswa() {
        ...
        Object[][] objekMahasiswa = new Object[DataMahasiswa.getDataFana().size()][3];
        int i = 0;
        for(Mahasiswa1841720155Fana mhs: DataMahasiswa.getDataFana()) {
            String arrayMahasiswa[] = {mhs.getNimFana(), mhs.getNamaFana(), mhs.getAlamatFana()};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DataMahasiswa.isiDataFana(jTextFieldNim.getText(), jTextFieldNama.getText(), jTextAlamat.getText());
        LihatDataMahasiswa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720155Fana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720155Fana().setVisible(true);
            }
        });
    }
